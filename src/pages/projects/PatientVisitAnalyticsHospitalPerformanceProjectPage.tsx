...
import { Download, FileUp, Loader2, Sparkles, Stethoscope, Users, IndianRupee, ClipboardList } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F8FBFF_100%)] p-6">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#0F172A] md:text-5xl">Patient Visit Analytics & Hospital Performance</h1>
          <p className="mt-4 max-w-4xl text-lg leading-8 text-slate-600">Analyze hospital visits, doctor performance, admission rates, revenue trends, and patient load. AI-powered forecasting helps hospitals optimize staffing, scheduling, and resources.</p>
        </div>
              ...
              <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                  <div className="max-w-3xl">
                    ...
                    <p className="mt-4 text-base leading-7 text-slate-600">This project tracks patient flow across departments, revenue generation, admission behavior, and doctor performance so hospital teams can spot pressure points and plan resources with confidence.</p>
                  </div>
                  <div className="rounded-3xl border border-[#CCFBF1] bg-[#ECFDF5] px-5 py-4 text-[#0F766E] shadow-sm">
                    ...
                    <p className="mt-2 text-sm leading-6">Built for patient volume monitoring, revenue visibility, and admission forecasting.</p>
                  </div>
                </div>
              </section>

              <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                <ProjectMetricCard icon={<Users className="h-5 w-5 text-[#0F766E]" />} label="Total Patients" value="Static label" accent="bg-[#ECFDF5]" />
                <ProjectMetricCard icon={<IndianRupee className="h-5 w-5 text-[#0369A1]" />} label="Total Revenue" value="Static label" accent="bg-[#EFF6FF]" />
                <ProjectMetricCard icon={<ClipboardList className="h-5 w-5 text-[#B45309]" />} label="Admission Rate" value="Static label" accent="bg-[#FFFBEB]" />
                <ProjectMetricCard icon={<Stethoscope className="h-5 w-5 text-[#7C3AED]" />} label="Revenue per Patient" value="Static label" accent="bg-[#F5F3FF]" />
              </div>
            </div>
          </TabPanel>
          ...
          <TabPanel>
            <div className="space-y-6">
              <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                ...
                <p className="mt-3 max-w-3xl text-slate-600">The table below captures the hospital data needed for loading, filtering, charting, and prediction.</p>
                      ...
                      <TableBody>
                        {REQUIRED_FIELDS.map((field) => (
                          <TableRow key={field}>
                            ...
                            <TableCell className="text-slate-600">{REQUIRED_FIELD_DESCRIPTIONS[field]}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
              ...
              <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Button type="button" variant="secondary" onClick={() => void loadDefaultDataset()}>
                      Reload Default Data
                    </Button>
                  </div>
                </div>
                ...
                {mode === 'default' && !loading && data.length > 0 && (
                  <div className="mt-6 rounded-[28px] border border-slate-200 bg-slate-50 p-5">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <Button type="button" variant="outline" onClick={() => void downloadRows(data, 'default_patient_visit_data.csv')}>
              ...
              {mode === 'mapping' && uploadFile && fileColumns.length > 0 && (
                <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    <Button type="button" onClick={() => void applyMapping()}>Apply Mapping</Button>
                  </div>
                </section>
              )}
                ...
                <>
                  ...
                  <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                    ...
                    <div className="mt-6 grid gap-5 xl:grid-cols-4">
                      <ProjectMetricCard icon={<Users className="h-5 w-5 text-[#0F766E]" />} label="Total Patients" value={kpis ? formatCell(kpis.total_patients) : '—'} accent="bg-[#ECFDF5]" />
                      <ProjectMetricCard icon={<IndianRupee className="h-5 w-5 text-[#0369A1]" />} label="Total Revenue" value={kpis ? formatMoney(kpis.total_revenue) : '—'} accent="bg-[#EFF6FF]" />
                      <ProjectMetricCard icon={<ClipboardList className="h-5 w-5 text-[#B45309]" />} label="Admission Rate" value={kpis ? formatPercent(kpis.admission_rate_pct) : '—'} accent="bg-[#FFFBEB]" />
                      <ProjectMetricCard icon={<Stethoscope className="h-5 w-5 text-[#7C3AED]" />} label="Revenue Per Patient" value={kpis ? formatMoney(kpis.revenue_per_patient) : '—'} accent="bg-[#F5F3FF]" />
                    </div>
                  </section>
                  ...
                  <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <Button type="button" variant="outline" onClick={exportInsights}>
                        <Download className="h-4 w-4" />
                        Download Insights
                      </Button>
                    </div>
