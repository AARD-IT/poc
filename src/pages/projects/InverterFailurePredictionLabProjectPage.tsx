...
import { Activity, BarChart3, Download, FileUp, Gauge, Loader2, ShieldAlert, Sparkles, Thermometer, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F8FBFF_100%)] p-6">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-[#0F172A] md:text-5xl">Inverter Failure Prediction Lab</h1>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <section className="rounded-[32px] border border-[#E2E8F0] bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="mt-5 rounded-3xl border border-slate-200 bg-slate-50 p-6">
                    <div className="rounded-2xl border border-[#CCFBF1] bg-white px-4 py-3 text-sm font-semibold text-[#0F766E]">failure_within_7_days</div>
